...
// $HeadURL: https://svn.east.isi.edu/torc/trunk/src/torc/Generic.hpp $
// $Id: Generic.hpp 386 2011-02-24 16:32:20Z nsteiner $
 ...
 * (edif ALTERA
  ...
  (keywordMap (keywordLevel  0))
    (status
      (written
        (timeStamp 2004 0 0 0 0 0)
        (author "Starbridge")
        (program "File for Viva's net list output."
          (version "1.0"))
      )
    )
    (library active_lib
